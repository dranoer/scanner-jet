...
import com.gulofy.scannerjet.adapter.ColorEffectAdapter;
import com.gulofy.scannerjet.adapter.ColorFilterAdapter;
import com.gulofy.scannerjet.adapter.EditToolsAdapter;
import com.gulofy.scannerjet.adapter.FontAdapter;
import com.gulofy.scannerjet.adapter.OverlayAdapter;
import com.gulofy.scannerjet.adapter.SignatureAdapter;
import com.gulofy.scannerjet.adapter.WatermarkFontAdapter;
import com.gulofy.scannerjet.db.DBHelper;
import com.gulofy.scannerjet.document_view.ColorFilter;
import com.gulofy.scannerjet.main_utils.AdjustUtil;
...
//        ly_aspectratio.setAspectRatio((float) Constant.original.getWidth(), (float) Constant.original.getHeight());
    ...
    private void setEditToolsAdapter() {
        ...
        editToolsAdapter = new EditToolsAdapter(this,DocumentEditorActivity.this);
        ...
        switch (editToolType) {
            ...
            case PICTURE:
                ImagePicker.with((Activity) this)
                        ...
                        .setMaxSize(1)
                        .setShowCamera(false)
                        .setLimitMessage(getString(R.string.select_image_limit))
                        .setRequestCode(100)
                        .start();
                return;
            case SIGNATURE:
                            ...
                            default:
                                switch (id) {
                                    ...
                                    case R.id.iv_close_watermark:
                                        ...
                                        return;
                                    case R.id.llColor:
                                        ColorPickerDialogBuilder.with(this).setTitle(getString(R.string.choose_color)).initialColor(brush_color).wheelType(ColorPickerView.WHEEL_TYPE.FLOWER).density(10).setOnColorSelectedListener(new OnColorSelectedListener() {
                                            @Override
                                            public void onColorSelected(int i) {
                                            }
                                        }).setPositiveButton((CharSequence) getString(R.string.ok1), (ColorPickerClickListener) new ColorPickerClickListener() {
                                            @Override
