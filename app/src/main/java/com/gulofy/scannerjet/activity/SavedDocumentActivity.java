...
public class SavedDocumentActivity extends BaseActivity implements View.OnClickListener {
    ...
    BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (Constant.IdentifyActivity.equals("ScannerActivity_Retake2")) {
                Intent newIntent=new Intent(SavedDocumentActivity.this,ScannerActivity.class);
    ...
    public void onResume() {
        ...
        registerReceiver(broadcastReceiver, new IntentFilter(getPackageName() + ".ScannerActivity_Retake2"), RECEIVER_EXPORTED);
        registerReceiver(broadcastReceiver, new IntentFilter(getPackageName() + ".DocumentEditorActivity_Saved"), RECEIVER_EXPORTED);
    }
