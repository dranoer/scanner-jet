...
import com.gulofy.scannerjet.scrapbook.ImageStickerConfig;
import com.gulofy.scannerjet.scrapbook.LocalDisplay;
import com.gulofy.scannerjet.scrapbook.StickerConfigInterface;
import com.gulofy.scannerjet.scrapbook.StickerHolderView;
import com.gulofy.scannerjet.scrapbook.TextStickerConfig;
...
public class IDCardPreviewActivity extends BaseActivity implements View.OnClickListener, StickerHolderView.OnStickerSelectionCallback {
        ...
        public void onReceive(Context context, Intent intent) {
            if (Constant.IdentifyActivity.equals("DocumentEditorActivity_IDCard")) {
                ...
                ImagePicker.with((Activity) IDCardPreviewActivity.this)
                        ...
                        .setMaxSize(7)
                        .setShowCamera(false)
                        .setLimitMessage(getString(R.string.select_image_limit_7))
                        .setRequestCode(100)
                        .start();
                Constant.IdentifyActivity = "";
            }
    ...
    private void bindView() {
        ...
        if (!Constant.current_camera_view.equals(getString(R.string.id_card)) || !Constant.card_type.equals("Single")) {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.ly_vertical:
                ...
                return;
            case R.id.ly_color:
                ColorPickerDialogBuilder.with(this).setTitle(getString(R.string.choose_color)).initialColor(color).wheelType(ColorPickerView.WHEEL_TYPE.FLOWER).density(10).setOnColorSelectedListener(new OnColorSelectedListener() {
                    public void onColorSelected(int i) {
                    }
                }).setPositiveButton((CharSequence) getString(R.string.ok), (ColorPickerClickListener) new ColorPickerClickListener() {
                    public void onClick(DialogInterface dialogInterface, int i, Integer[] numArr) {
                        color = i;
                        iv_bg_color.setBackgroundColor(i);
                        ly_main.setBackgroundColor(i);
                    }
                }).setNegativeButton((CharSequence) getString(R.string.dialog_cancel), (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
    ...
    private class saveIDCard extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        public Bitmap doInBackground(Bitmap... bitmapArr) {
            ...
            if (Constant.inputType.equals("Group")) {
                group_name = "ScannerJet" + Constant.getDateTime("_ddMMHHmmss");
