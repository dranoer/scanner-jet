...
public class Languages {
    public static final Lang ENGLISH = new Lang(0, "en", "English", "English","flags/flag_ml.png");
...
//    public static final Lang BELARUSIAN = new Lang(8, "be", "беларускі", "Belarusian");
    public static final Lang BULGARIAN = new Lang(9, "bg", "Български", "Bulgarian","flags/flag_bg.png");
...
//    public static final Lang PERSIAN = new Lang(13, "fa", "Persian", "Persian");
    public static final Lang AFRIKAANS = new Lang(14, "af", "Afrikaans", " ","flags/flag_af.png");
//    public static final Lang DANISH = new Lang(15, "da", "Dansk", "Danish");
    public static final Lang GERMAN = new Lang(16, "de", "Deutsch", "German","flags/flag_de.png");
    public static final Lang RUSSIAN = new Lang(17, "ru", "Русский", "Russian","flags/flag_ru.png");
    public static final Lang FRENCH = new Lang(18, "fr", "Français", "French","flags/flag_fr.png");
...
//    public static final Lang GEORGIAN = new Lang(23, "ka", "ქართული", "Georgian");
    //public static final Lang GUJARATI = new Lang(24, "gu", "ગુજરાતી", "Gujarati","flags/flag_gu.png");
...
//    public static final Lang HAUSA = new Lang(28, "ha", "Hausa", "Hausa");
    public static final Lang DUTCH = new Lang(29, "nl", "Nederlands", "Dutch","flags/flag_nl.png");
...
//    public static final Lang MALTESE = new Lang(45, "mt", "Il-Malti", "Maltese");
   // public static final Lang MARATHI = new Lang(46, "mr", "मराठी", "Marathi","flags/flag_mr.png");
    public static final Lang MALAYALAM = new Lang(47, "ml", "മലയാളം", "Malayalam","flags/flag_ml.png");
  //  public static final Lang MALAY = new Lang(48, "ms", "Melayu", "Malay","flags/flag_ml.png");
...
//    public static final Lang ZULU = new Lang(56, "zu", "Zulu", "Zulu");
    public static final Lang NEPALI = new Lang(57, "ne", "नेपाली", "Nepali","flags/flag_ne.png");
//    public static final Lang NORWEGIAN = new Lang(58, "no", "Norsk", "Norwegian");
  //  public static final Lang PUNJABI = new Lang(59, "pa", "ਪੰਜਾਬੀ", "Punjabi","flags/flag_pa.png");
...
//    public static final Lang CHICHEWA = new Lang(62, "ny", "Chichewa", "Chichewa");
    public static final Lang JAPANESE = new Lang(63, "ja", "日本語", "Japanese","flags/flag_ja.png");
    public static final Lang SWEDISH = new Lang(64, "sv", "Svenska", "Swedish","flags/flag_sv.png");
...
//    public static final Lang TAJIK = new Lang(76, "tg", "Тоҷикӣ", "Tajik");
  //  public static final Lang TELUGU = new Lang(77, "te", "తెలుగు", "Telugu","flags/flag_te.png");
  //  public static final Lang TAMIL = new Lang(78, "ta", "தமிழ்", "Tamil","flags/flag_ta.png");
...
//    public static final Lang WELSH = new Lang(81, "cy", "Cymraeg", "Welsh");
 //   public static final Lang URDU = new Lang(82, "ur", "اردو", "Urdu","flags/flag_ur.png");
...
//    public static final Lang UZBEK = new Lang(84, "uz", "O'zbek", "Uzbek");
    public static final Lang SPANISH = new Lang(85, "es", "Español", "Spanish","flags/flag_es.png");
//    public static final Lang HEBREW = new Lang(86, "iw", "עברית", "Hebrew");
    public static final Lang GREEK = new Lang(87, "el", "Ελληνικά", "Greek","flags/flag_el.png");
//    public static final Lang HAWAIIAN = new Lang(88, "haw", "Hawaiian", "Hawaiian");
   // public static final Lang SINDHI = new Lang(89, "sd", "سنڌي", "Sindhi","flags/flag_ur.png");
...
//    public static final Lang YIDDISH = new Lang(95, "yi", "ייִדיש", "Yiddish");
    public static final Lang HINDI = new Lang(96, "hi", "हिंदी", "Hindi","flags/flag_ml.png");
...
//    public static final Lang YORUBA = new Lang(101, "yo", "Yorùbá", "Yoruba");
    public static final Lang VIETNAMESE = new Lang(102, "vi", "Tiếng Việt", "Vietnamese","flags/flag_vi.png");
//    public static final Lang CHINESE_TRADITIONAL = new Lang(103, "zh-TW", "正體中文", "Chinese Traditional");
    public static final Lang CHINESE_SIMPLIFIED = new Lang(104, "zh", "简体中文", "Chinese Simplified","flags/flag_zh.png");
...
//        sLanguages.put(86, HEBREW);
        sLanguages.put(78, GREEK);
        sLanguages.put(17, MALAYALAM);
